...
public class GameCommander {
	...
	// 시간 체크
	final long warnDuration = 100;
	long startTime = 0;
	
	public void timeLagCheckStart() {
		startTime = System.currentTimeMillis();
	}
	public void timeLagCheck(String managerName) {
		long currentTime = System.currentTimeMillis();
		if (currentTime - startTime > warnDuration) {
			System.out.println("###" + managerName + " : " + (currentTime - startTime) + " millisec");
		}
