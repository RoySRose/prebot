...
import pre.util.MicroSet.Combat;
...
//			if(SquadName.MAIN_ATTACK.equals(squad.getName())) {
//				MyBotModule.Broodwar.drawCircleMap(enemyPosition, MicroSet.Combat.ATTACK_RADIUS, Color.Brown);
//			}
