...
public class StrategyManager {
	...
	public void update() {
		...
		executeCombat();
		executeMarineIntoBunker();
		//if(CurrentStrategyException.toString() == "zergException_NongBong" || CurrentStrategyException.toString() == "terranException_CheeseRush"){
		//농봉 테스트 성공
		/*if((WorkerManager.Instance().getNumMineralWorkers() > 7 && NongBong_Chk ==0 ) || (NongBong_Chk != 0 &&NongBong_Chk < 10000)){
			executeNongBong();
		}*/
