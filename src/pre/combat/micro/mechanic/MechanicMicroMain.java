...
//		executeGoliathControl();
	...
	private void executeControl() {
		...
		mechanicVulture.prepareMechanicAdditional(tankList, goliathList);
		
		mechanicChecker.prepareMechanic(checkOrder, checkerEnemies);
		mechanicChecker.prepareMechanicAdditional(tankList, goliathList);
		
		mechanicWatcher.prepareMechanic(watchOrder, watcherEnemies);
		mechanicWatcher.prepareMechanicAdditional(tankList, goliathList);
