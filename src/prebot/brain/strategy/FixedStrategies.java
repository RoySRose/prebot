...
public class FixedStrategies {
	...
	public static final class InitialStrategyForProtoss extends FixedStrategy {
		public InitialStrategyForProtoss() {
			knowledgeList.add(new InerrableInitials.MechanicGasAdjustment());
			knowledgeList.add(new InerrableInitials.ScvScoutAfterBuild(UnitType.Terran_Supply_Depot, 0));
