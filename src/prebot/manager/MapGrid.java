...
public class MapGrid extends GameManager {
	...
	class GridCell {
		public int timeLastVisited; /// < 가장 마지막에 방문했던 시각이 언제인지 -> Scout 에 활용
		public int timeLastOpponentSeen; /// < 가장 마지막에 적을 발견했던 시각이 언제인지 -> 적 의도 파악, 적 부대 파악, 전략 수립에 활용
		public List<Unit> ourUnits = new ArrayList<Unit>();
		public List<Unit> oppUnits = new ArrayList<Unit>();
	...
	private GridCell getCell(Position pos) {
