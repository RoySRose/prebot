...
//				MyBotModuleOriginal.Broodwar.drawTextScreen(250, 100, "I lost because of EXCEPTION");
//
//				if (MyBotModuleOriginal.Broodwar.getFrameCount() - exceptionLostConditionSatisfiedFrame >= maxDurationForExceptionLostCondition) {
//					MyBotModuleOriginal.Broodwar.leaveGame();
//				}
//			}
//	    }
//		
...
//
//		for (Unit unit : MyBotModuleOriginal.Broodwar.self().getUnits()) {
...
//			MyBotModuleOriginal.Broodwar.sendText("I lost because I HAVE NO UNIT TO DEFEAT ENEMY PLAYER");
//			MyBotModuleOriginal.Broodwar.sendText("GG");
//			System.out.println("I lost because I HAVE NO UNIT TO DEFEAT ENEMY PLAYER");
//
//			isGameLostConditionSatisfied = true;
//			gameLostConditionSatisfiedFrame = MyBotModuleOriginal.Broodwar.getFrameCount();
//		}
//		// 자동 패배조건 벗어나게 되면 리셋
...
//
//			MyBotModuleOriginal.Broodwar.drawTextScreen(250, 100, "I lost because I HAVE NO UNIT TO DEFEAT ENEMY PLAYER");
//			MyBotModuleOriginal.Broodwar.drawTextScreen(250, 115, "I will leave game in " 
//					+ (maxDurationForGameLostCondition - (MyBotModuleOriginal.Broodwar.getFrameCount() - gameLostConditionSatisfiedFrame)) 
//					+ " frames");
//
//			if (MyBotModuleOriginal.Broodwar.getFrameCount() - gameLostConditionSatisfiedFrame >= maxDurationForGameLostCondition) {
//				MyBotModuleOriginal.Broodwar.leaveGame();
//			}
//		}
//	}
...
//
//				MyBotModuleOriginal.Broodwar.drawTextScreen(250, 100, "I lost because of TIMEOUT");
//
//				if (MyBotModuleOriginal.Broodwar.getFrameCount() - timeOutConditionSatisfiedFrame >= maxDurationForTimeOutLostCondition) {
//
