...
import prebot.micro.control.MechanicMicroGoliath;
import prebot.micro.control.MechanicMicroTank;
import prebot.micro.control.MechanicMicroVulture;
import prebot.micro.control.MicroBuilding;
import prebot.micro.control.MicroGoliath;
import prebot.micro.control.MicroMarine;
import prebot.micro.control.MicroScv;
import prebot.micro.control.MicroTank;
import prebot.micro.control.MicroVessel;
import prebot.micro.control.MicroVulture;
import prebot.micro.control.MicroWraith;
...
//				}
				...
				if (result == Result.LOSS) {
					CombatManager.Instance().setDetailStrategy(CombatStrategyDetail.VULTURE_JOIN_SQUAD, MicroConfig.Vulture.getVultureJoinSquadFrame(InformationManager.Instance().enemyRace));
					saveUnitLevelVulture = 2;
