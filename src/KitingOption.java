...
public class KitingOption {
	...
	public static KitingOption defaultKitingOption() {
		return new KitingOption(true, true, null, MicroSet.FleeAngle.NARROW_ANGLE, false);
	}
	public static KitingOption vultureKitingOption() {
		return new KitingOption(false, false, null, MicroSet.FleeAngle.WIDE_ANGLE, false);
	}
