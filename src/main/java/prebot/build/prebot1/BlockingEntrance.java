...
public class BlockingEntrance {
	...
	private static int BuildingSpacingOld = BuildConfig.buildingSpacing;
	/// 건물과 건물간 띄울 최소한의 간격 - ResourceDepot 건물의 경우 (Nexus, Hatchery, Command Center)
	private static int BuildingResourceDepotSpacingOld = BuildConfig.buildingResourceDepotSpacing;
	...
	public void SetBlockingPosition() { 
		BuildConfig.buildingSpacing = 0;
		BuildConfig.buildingResourceDepotSpacing = 0;
		//헌터
