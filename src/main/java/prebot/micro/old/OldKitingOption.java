...
public class OldKitingOption {
	
	public OldKitingOption(boolean cooltimeAlwaysAttack, boolean unitedKiting, Integer[] fleeAngle, Position goalPosition) {
		this.cooltimeAlwaysAttack = cooltimeAlwaysAttack;
		this.unitedKiting = unitedKiting;
		this.fleeAngle = fleeAngle;
		this.goalPosition = goalPosition;
	}
	public static OldKitingOption defaultKitingOption() {
		return new OldKitingOption(true, true, MicroConfig.FleeAngle.NARROW_ANGLE, null);
	}
	public static OldKitingOption vultureKitingOption() {
		return new OldKitingOption(false, false, MicroConfig.FleeAngle.WIDE_ANGLE, null);
	}
