...
import bwapi.Unit;
import prebot.micro.constant.MicroCode;
import prebot.micro.constant.MicroCode.SquadOrderType;

public class OldSquadOrder {
	...
	public OldSquadOrder(SquadOrderType type, Position position, int radius, String status, Unit unitleader) {
		this.type = type;
	...
	public OldSquadOrder(SquadOrderType type, Position position, int radius, String status) {
		this.type = type;
		this.position = position;
		this.radius = radius;
		this.status = status;
