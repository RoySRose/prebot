...
public class ScoutManager{
	...
	{
		// 1초에 6번만 실행합니다
		if (Prebot.Broodwar.getFrameCount() % 4 == 0){
...
//				distrubMineral();
//				if (distrubMineral && Prebot.Broodwar.getFrameCount() % 20 == 0) updateScoutUnit();
...
//					if (unit != null)
	...
	public void moveScoutUnit()
	{
		...
		if (enemyBaseLocation != null && enemyBaseLocation.getDistance(myBaseLocation.getPosition()) < 5 * BuildConfig.TILE_SIZE)
		...
		if (enemyBaseLocation == null)
		{
			...
			if (currentScoutTargetBaseLocation == null || currentScoutUnit.getDistance(currentScoutTargetBaseLocation.getPosition()) < 5 * BuildConfig.TILE_SIZE) 
			{
...
//        Prebot.Broodwar.drawCircleMap(fleeTo, 5, Color.Red, true);
...
////					Prebot.Broodwar.drawTextMap(x1 + 3, y1 + 2, "" + MapTools.Instance().getGroundDistance(tp.toPosition(), basePosition));
