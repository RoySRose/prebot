...
//					if (unit != null)
	...
	public void moveScoutUnit()
	{
		...
		if (enemyBaseLocation != null && enemyBaseLocation.getDistance(myBaseLocation.getPosition()) < 5 * DrawConfig.TILE_SIZE)
		...
		if (enemyBaseLocation == null)
		{
			...
			if (currentScoutTargetBaseLocation == null || currentScoutUnit.getDistance(currentScoutTargetBaseLocation.getPosition()) < 5 * DrawConfig.TILE_SIZE) 
			{
