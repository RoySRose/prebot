...
public class BuildingSquad extends Squad {
	...
	public void execute() {
		...
		// Set<UnitInfo> barracksEuiList = findEnemies(barracksList);
		...
		// Set<UnitInfo> engineeringBayEuiList = findEnemies(engineeringBayList);
		...
		//Set<UnitInfo> commandCenterEuiList = findEnemies(commandCenterList);
		...
		// Set<UnitInfo> scienceFacilityEuiList = findEnemies(scienceFacilityList);
...
//	public Set<UnitInfo> findEnemies(List<Unit> unitList) {
//		Set<UnitInfo> euis = new HashSet<>();
//		for (Unit unit : unitList) {
//			UnitUtils.addEnemyUnitInfosInRadiusForAir(euis, unit.getPosition(), unit.getType().sightRange() + MicroConfig.LARGE_ADD_RADIUS);
//		}
//		return euis;
//	}
