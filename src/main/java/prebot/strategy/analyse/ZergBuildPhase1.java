...
//		enemyUnitTypes.add(UnitType.Zerg_Spawning_Pool);
//		enemyUnitTypes.add(UnitType.Zerg_Hatchery); // ignore enemybase hatchery
//		enemyUnitTypes.add(UnitType.Zerg_Extractor);
//		enemyUnitTypes.add(UnitType.Zerg_Overlord); // ignore first overload
//		enemyUnitTypes.add(UnitType.Zerg_Zergling);
//	}
//
//	/// 유닛 발견 맵을 분석한 정보
//	@Override
...
//
//	@Override
//	protected void expectStrategy() {
//		if (is5DroneBuild) {
//			enemyBuildExpected = EnemyStrategy.ZERG_5DRONE;
...
//					enemyBuildExpected = EnemyStrategy.ZERG_9DRONE_GAS;
//				}
...
//		int firstPoolBuildSec = buildStartFrameMap.get(firstPool.getUnitID());
...
//		}
//
//		int secondHatchBuildSec = buildStartFrameMap.get(secondHatchInfo.getUnitID());
