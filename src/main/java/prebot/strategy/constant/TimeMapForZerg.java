...
public class TimeMapForZerg {
	...
	public static DefaultTimeMap ZERG_9DRONE_GAS() {
		return new DefaultTimeMap()
		.put(UnitType.Zerg_Spawning_Pool, 1, 15)
	...
	public static DefaultTimeMap ZERG_9DRONE_GAS_DOUBLE() {
		return new DefaultTimeMap();
	}
	
	public static DefaultTimeMap ZERG_OVERPOOL() {
		return new DefaultTimeMap()
	...
	public static DefaultTimeMap ZERG_OVERPOOL_GAS() {
		return new DefaultTimeMap()
		.put(UnitType.Zerg_Overlord, 0, 55)
		.put(UnitType.Zerg_Spawning_Pool, 1, 20)
	...
	public static DefaultTimeMap ZERG_OVERPOOL_GAS_DOUBLE() {
		return new DefaultTimeMap();
	}
	
	public static DefaultTimeMap ZERG_2HAT_GAS() {
		return new DefaultTimeMap()
		.put(UnitType.Zerg_Overlord, 0, 55)
	...
	public static DefaultTimeMap ZERG_3HAT() {
		return new DefaultTimeMap()
		.put(UnitType.Zerg_Overlord, 0, 55)
		.put(UnitType.Zerg_Hatchery, 1, 50)
		.put(UnitType.Zerg_Spawning_Pool, 2, 5)
