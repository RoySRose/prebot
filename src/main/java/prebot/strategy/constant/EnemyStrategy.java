...
public class EnemyStrategy {
	...
	public static enum Strategy {
		...
		private Strategy(int vultureRatio, int tankRatio, int goliathRatio, int weight) {
	...
	public static enum StrategyException { 
		...
		private StrategyException(int vultureRatio, int tankRatio, int goliathRatio, int weight) {
			this.vultureRatio = vultureRatio;
			this.tankRatio = tankRatio;
			this.goliathRatio = goliathRatio;
			this.weight = weight;
